                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="text-center min-w-48">
                      <h2 className="text-lg font-semibold">
                        ...
                        {viewMode === 'week' && `${format(startOfWeek(currentDate, { weekStartsOn: 1 }), 'yyyy年M月d日', { locale: zhCN })} - ${format(addDays(startOfWeek(currentDate, { weekStartsOn: 1 }), 6), 'M月d日', { locale: zhCN })}`}
