...
import {
  GestureEnhancedCard,
  SwipeableCarousel,
} from '../../components/dashboard/GestureComponents';
...
function TestSwipeComponent({ onSwipeLeft, onSwipeRight }: any) {
  ...
  return (
    <div ref={divRef} data-testid='swipe-area'>
      Swipe Area
    </div>
  );
}
...
function TestLongPressComponent({ onLongPress }: any) {
  ...
  return (
    <div data-testid='long-press-area' {...longPressHandlers}>
      Long Press Area
    </div>
  );
}
...
describe('Gesture Components', () => {
  ...
  describe('SwipeableCarousel', () => {
    ...
    it('handles single item without navigation', () => {
      const items = [<div key='1'>Single Item</div>];
