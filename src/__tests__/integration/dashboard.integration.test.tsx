...
describe("Dashboard Integration Tests", () => {
  ...
  it("renders dashboard with all components", async () => {
    render(<EnhancedDashboard userEmail="test@example.com" />);
  ...
  it("displays loading state initially", () => {
    ...
    expect(screen.getByText("正在加载家庭数据...")).toBeInTheDocument();
  });
  ...
  it("maintains component state on re-render", async () => {
    ...
    rerender(<EnhancedDashboard userEmail="test@example.com" />);
