...
describe('api_social_achievements_route', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
  ...
  describe('GET', () => {
    it('should handle GET request', async () => {
      ...
      const { GET } = require('@/app/api/social/achievements/route');
      ...
      const { req, res } = createMocks({
        method: 'GET',
        url: '/social/achievements/route.ts',
      });

      // Execute
      // const response = await GET(new NextRequest('http://localhost:3000/social/achievements/route.ts'), { params: {} });
  ...
  describe('POST', () => {
    it('should handle POST request', async () => {
      ...
      // const { POST } = require('@/app/api/social/achievements/route');
