...
describe('api_social_stats_route', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
  ...
  describe('GET', () => {
    it('should handle GET request', async () => {
      ...
      const { GET } = require('@/app/api/social/stats/route');
      ...
      const { req, res } = createMocks({
        method: 'GET',
        url: '/social/stats/route.ts',
      });

      // Execute
      // const response = await GET(new NextRequest('http://localhost:3000/social/stats/route.ts'), { params: {} });
  ...
  describe('POST', () => {
    it('should handle POST request', async () => {
      ...
      // const { POST } = require('@/app/api/social/stats/route');
