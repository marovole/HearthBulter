...
describe('api_social_share_[token]_route', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
  ...
  describe('GET', () => {
    it('should handle GET request', async () => {
      ...
      const { GET } = require('@/app/api/social/share/[token]/route');
      ...
      const { req, res } = createMocks({
        method: 'GET',
        url: '/social/share/$1/route.ts',
      });

      // Execute
      // const response = await GET(new NextRequest('http://localhost:3000/social/share/$1/route.ts'), { params: {} });
  ...
  describe('POST', () => {
    it('should handle POST request', async () => {
      ...
      // const { POST } = require('@/app/api/social/share/[token]/route');
