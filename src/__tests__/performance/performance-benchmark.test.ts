...
describe('性能基准测试', () => {
  ...
  describe('数据库查询性能基准测试', () => {
    test('家庭查询性能应满足基准', async () => {
      ...
      console.log(`家庭查询平均时间: ${avgQueryTime.toFixed(2)}ms, 最大时间: ${maxQueryTime.toFixed(2)}ms`)
    })
    ...
    test('家庭成员查询性能应满足基准', async () => {
      ...
      console.log(`家庭成员查询平均时间: ${avgQueryTime.toFixed(2)}ms, 最大时间: ${maxQueryTime.toFixed(2)}ms`)
    })
    ...
    test('计数查询性能应满足基准', async () => {
      ...
      console.log(`计数查询平均时间: ${avgQueryTime.toFixed(2)}ms, 最大时间: ${maxQueryTime.toFixed(2)}ms`)
    })
  })
  ...
  describe('频率限制性能基准测试', () => {
    test('频率限制检查性能应满足基准', async () => {
      ...
      console.log(`频率限制检查平均时间: ${avgCheckTime.toFixed(4)}ms, 最大时间: ${maxCheckTime.toFixed(4)}ms`)
    })
  ...
  describe('性能监控基准测试', () => {
    ...
    test('性能指标收集准确性', async () => {
      ...
      console.log(`性能指标收集准确性: 总请求数=${metrics.responseTime.total}, 平均响应时间=${metrics.responseTime.avg.toFixed(2)}ms`)
    })
  })
  ...
  describe('并发性能基准测试', () => {
    test('并发请求处理性能', async () => {
      ...
      console.log(`并发${concurrentRequests}个请求: 平均=${avgTime.toFixed(2)}ms, 最大=${maxTime.toFixed(2)}ms, 最小=${minTime.toFixed(2)}ms`)
    })
  })
