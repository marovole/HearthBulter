...
import { nutritionCalculatorService } from '@/lib/services/nutrition-calculator';
...
describe('nutrition-calculator', () => {
  ...
  beforeEach(() => {
    jest.clearAllMocks();
    service = nutritionCalculatorService.getInstance();
  });

  describe('Initialization', () => {
    it('should create service instance', () => {
      expect(service).toBeDefined();
      expect(service).toBeInstanceOf(nutritionCalculatorService);
    });

    it('should return same instance (singleton)', () => {
      const instance2 = nutritionCalculatorService.getInstance();
