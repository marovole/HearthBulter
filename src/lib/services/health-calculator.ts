...
export function calculateMealMacros(
  ...
  if (lastMeal) {
    lastMeal.calories += dailyMacros.calories - totalCalories;
    lastMeal.protein += dailyMacros.protein - totalProtein;
    lastMeal.carbs += dailyMacros.carbs - totalCarbs;
    lastMeal.fat += dailyMacros.fat - totalFat;
  }
