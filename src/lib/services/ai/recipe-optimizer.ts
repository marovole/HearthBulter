...
export class RecipeOptimizer {
  ...
  async optimizeRecipeForHealth(
    ...
    const targetNutrition = preferences.targetNutrition ?? {
      calories: 0,
      protein: 0,
      carbs: 0,
      fat: 0,
    ...
    return this.optimizeRecipe({ id: recipeId, memberId }, targetNutrition, preferences);
  }
