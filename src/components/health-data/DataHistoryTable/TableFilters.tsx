      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="flex items-center space-x-2">
          <input
            ...
            onChange={(e) => onFilterChange(prev => ({ ...prev, hasWeight: e.target.checked }))}
        ...
        <div className="flex items-center space-x-2">
          <input
            ...
            onChange={(e) => onFilterChange(prev => ({ ...prev, hasBloodPressure: e.target.checked }))}
            className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
          />
        ...
        <div className="flex items-center space-x-2">
          <input
            ...
            onChange={(e) => onFilterChange(prev => ({ ...prev, hasHeartRate: e.target.checked }))}
            className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
          />
