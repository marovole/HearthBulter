      ...
      <div>
        <div className="mb-4 flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center space-x-2 rounded-lg bg-blue-50 px-4 py-2 text-sm font-medium text-blue-600 hover:bg-blue-100 disabled:cursor-not-allowed disabled:opacity-50"
          >
            ...
            <div key={device.id} className="rounded-lg border border-gray-200 p-4">
              <div className="mb-3 flex items-start justify-between">
                <div className="flex items-center space-x-3">
                  <div className="rounded-lg bg-gray-100 p-2">{getDeviceIcon(device.type)}</div>
                  <div>
                ...
                {device.lastSync && (
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-medium text-gray-900">
                      {Math.floor((Date.now() - device.lastSync.getTime()) / (1000 * 60))}
                      分钟前
                    </span>
                  </div>
                )}
              ...
              <button
                ...
                className="mt-3 flex w-full items-center justify-center space-x-2 rounded-lg bg-blue-600 px-3 py-2 text-sm text-white hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-50"
              >
                <RefreshCw className={`h-4 w-4 ${syncing ? "animate-spin" : ""}`} />
                <span>立即同步</span>
              </button>
        ...
        <div>
          ...
          <div className="space-y-3">
            {pendingData.map((data) => (
              <div key={data.id} className="rounded-lg border border-gray-200 p-4">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">
                          ...
                          {Math.floor((Date.now() - data.timestamp.getTime()) / (1000 * 60))}
                          分钟前
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center space-x-2">
                    <button
                      ...
                      className="flex items-center space-x-1 rounded bg-green-50 px-3 py-1 text-sm font-medium text-green-600 hover:bg-green-100"
                    >
                    ...
                    <button
                      ...
                      className="flex items-center space-x-1 rounded bg-red-50 px-3 py-1 text-sm font-medium text-red-600 hover:bg-red-100"
                    >
