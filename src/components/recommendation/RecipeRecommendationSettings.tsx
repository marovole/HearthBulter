...
type ArraySettingKey = "dietaryRestrictions" | "excludedIngredients" | "preferredCuisines";
...
export default function RecipeRecommendationSettings({
  ...
  const toggleArrayItem = (key: ArraySettingKey, item: string) => {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>调整您的偏好设置以获得更精准的个性化推荐</CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  updateSetting("season", (value as RecommendationSettings["season"]) || undefined)
                }
              >
                <SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Slider
              ...
              onValueChange={(value: number[]) =>
                updateSetting("servings", value[0] ?? settings.servings)
              }
              max={8}
              min={1}
              step={1}
          ...
          <div className="space-y-2">
            ...
            <Slider
              ...
              onValueChange={(value: number[]) =>
                updateSetting("maxCookTime", value[0] ?? settings.maxCookTime)
              }
              max={180}
              min={10}
              step={10}
          ...
          <div className="space-y-2">
            ...
            <Slider
              ...
              onValueChange={(value: number[]) =>
                updateSetting("budgetLimit", value[0] ?? settings.budgetLimit)
              }
              max={200}
              min={10}
              step={10}
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  updateSetting("spiceLevel", value as RecommendationSettings["spiceLevel"])
                }
              >
                <SelectTrigger>
                  <SelectValue />
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  updateSetting("sweetness", value as RecommendationSettings["sweetness"])
                }
              >
                <SelectTrigger>
                  <SelectValue />
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  updateSetting("saltiness", value as RecommendationSettings["saltiness"])
                }
              >
                <SelectTrigger>
                  <SelectValue />
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    updateSetting("costLevel", value as RecommendationSettings["costLevel"])
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
        ...
        {onApplySettings && (
          <div className="pt-4">
            <Button onClick={onApplySettings} className="w-full" disabled={loading}>
