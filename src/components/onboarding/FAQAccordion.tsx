...
export const defaultFAQData: FAQItem[] = [
  {
    ...
    answer:
      "开始使用 Health Butler 很简单！首先注册账户，然后按照新用户引导流程完成设置。您需要添加家庭成员信息、设置健康目标，然后就可以开始使用所有功能了。整个过程大约需要5-10分钟。",
    category: "入门指南",
    tags: ["新用户", "设置", "引导"],
    helpful: 45,
    notHelpful: 2,
  ...
  },
  {
    ...
    answer:
      "AI食谱推荐基于您的健康目标、饮食偏好、过敏信息、家庭成员情况等因素。系统会分析营养需求，推荐符合要求的食谱，并自动计算营养成分。您可以选择接受、修改或拒绝推荐。",
    category: "食谱规划",
    tags: ["AI推荐", "营养分析", "个性化"],
    helpful: 52,
    notHelpful: 1,
  ...
  },
  {
    ...
    question: "购物清单是如何生成的？",
    answer:
      "当您确认食谱计划后，系统会自动分析所需食材，生成购物清单。清单按商店区域分类，包含具体数量和规格。您可以手动添加其他物品，调整数量，或分享清单给家人。",
    category: "购物清单",
    tags: ["自动生成", "食材管理", "清单分享"],
    helpful: 41,
    notHelpful: 2,
  ...
  },
  {
    ...
    answer:
      "我们采用银行级加密技术保护您的数据，所有数据传输都通过SSL加密。您拥有完全的数据控制权，可以随时导出或删除数据。我们严格遵守隐私法规，不会未经授权分享您的个人信息。",
    category: "安全隐私",
    tags: ["数据加密", "隐私保护", "GDPR"],
    helpful: 47,
    notHelpful: 1,
