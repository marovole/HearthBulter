...
export function PriceComparison({ foodId, foodName, amount, onClose }: PriceComparisonProps) {
  ...
  const lowestPrice = sortedData[0]?.price ?? null;
  const highestPrice = sortedData[sortedData.length - 1]?.price ?? null;
        ...
        <div className="flex-1 overflow-y-auto">
          {error ? (
            ...
            <div className="p-6 text-center">
              <div className="mb-4 text-gray-500">暂无价格数据</div>
              <p className="text-sm text-gray-400">该商品暂时无法获取价格比较信息</p>
            </div>
          ) : (
                  ...
                  >
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <div className="flex items-center space-x-2">
                              <h3 className="font-medium text-gray-900">{item.platformName}</h3>
                              {isLowestPrice && (
                      ...
                      <div className="text-right">
                        ...
                        <span
                          className={`rounded-full px-2 py-1 text-xs ${getAvailabilityColor(item.availability)}`}
                        >
