      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>基于BMI、营养、运动和数据完整性的综合评分</CardDescription>
          </div>
        ...
        <Tabs defaultValue="overview" className="w-full">
          ...
          <TabsContent value="overview" className="space-y-4">
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              {/* 评分环形图 */}
              <div>
                <h3 className="mb-4 text-center text-lg font-semibold">评分分布</h3>
          ...
          <TabsContent value="breakdown" className="space-y-4">
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <div className="rounded-lg bg-gray-50 p-4">
                ...
                <div className="text-xs text-gray-500">得分: {data.breakdown.bmiScore}/30</div>
              </div>
              ...
              <div className="rounded-lg bg-gray-50 p-4">
                ...
                <div className="mb-2 text-sm text-gray-600">营养摄入达标率</div>
              ...
              <div className="rounded-lg bg-gray-50 p-4">
                ...
                <div className="mb-1 text-2xl font-bold">{data.details.activityFrequency}/30</div>
                <div className="mb-2 text-sm text-gray-600">过去30天记录天数</div>
                <div className="text-xs text-gray-500">得分: {data.breakdown.activityScore}/20</div>
              </div>
              ...
              <div className="rounded-lg bg-gray-50 p-4">
                ...
                <div className="mb-2 text-sm text-gray-600">健康指标完整度</div>
                <div className="text-xs text-gray-500">
          ...
          <TabsContent value="insights" className="space-y-4">
            ...
            {chartHistory.length > 0 && (
              <div>
                <h3 className="mb-4 text-lg font-semibold">评分趋势</h3>
