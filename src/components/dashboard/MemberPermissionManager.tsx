    ...
    <div className="rounded-lg bg-white shadow">
      ...
      <div className="p-6">
        ...
        <div className="space-y-6">
          {members.map((member) => (
            <div key={member.id} className="rounded-lg border border-gray-200 p-6">
              ...
              {/* 角色选择 */}
              <div className="mb-4">
                <label className="mb-2 block text-sm font-medium text-gray-700">用户角色</label>
              ...
              {/* 权限设置 */}
              <div>
                <label className="mb-3 block text-sm font-medium text-gray-700">详细权限</label>
