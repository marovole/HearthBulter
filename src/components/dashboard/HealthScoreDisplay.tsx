  ...
  return (
    <div className="rounded-lg bg-white p-6 shadow">
      ...
      <div className="mb-8 text-center">
        <div
          className={`inline-flex h-32 w-32 items-center justify-center rounded-full ${getScoreBgColor(data.currentScore)} mb-4`}
        >
          <div>
        ...
        <p className="text-gray-600">您的健康评分处于{getScoreLevel(data.currentScore)}水平</p>
      </div>

      {/* 评分细分 */}
      <div className="mb-8">
        <h4 className="mb-4 text-sm font-medium text-gray-700">评分细分</h4>
            ...
            return (
              <div
                ...
                className={`cursor-pointer rounded-lg border-2 p-4 transition-all hover:shadow-md ${
                  selectedFactor === factor ? "border-blue-500 bg-blue-50" : "border-gray-200"
                }`}
      ...
      {/* 健康建议 */}
      <div className="mb-6">
        <h4 className="mb-4 text-sm font-medium text-gray-700">个性化建议</h4>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    <div className="mb-1 flex items-center justify-between">
                      ...
                      <span
                        className={`rounded-full px-2 py-1 text-xs ${priorityColors[rec.priority]}`}
                      >
      ...
      {/* 历史趋势预览 */}
      <div>
        <h4 className="mb-4 text-sm font-medium text-gray-700">评分趋势（最近7天）</h4>
