...
export function HealthDataForm({ memberId, onSuccess, onCancel }: HealthDataFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        ...
        {/* 体脂率 */}
        <div>
          <label htmlFor="bodyFat" className="mb-1 block text-sm font-medium text-gray-700">
            体脂率 (%)
          </label>
          <input
            type="number"
        ...
        {/* 肌肉量 */}
        <div>
          <label htmlFor="muscleMass" className="mb-1 block text-sm font-medium text-gray-700">
            肌肉量 (kg)
          </label>
          <input
            type="number"
        ...
        {/* 血糖 */}
        <div>
          <label htmlFor="bloodSugar" className="mb-1 block text-sm font-medium text-gray-700">
            血糖 (mmol/L)
          </label>
          <input
            type="number"
        ...
        {/* 睡眠时长 */}
        <div>
          <label htmlFor="sleep" className="mb-1 block text-sm font-medium text-gray-700">
            睡眠时长 (小时)
          </label>
          <input
            type="number"
        ...
        {/* 步数 */}
        <div>
          <label htmlFor="steps" className="mb-1 block text-sm font-medium text-gray-700">
            步数
          </label>
          <input
            type="number"
        ...
        {/* 测量时间 */}
        <div>
          <label htmlFor="measuredAt" className="mb-1 block text-sm font-medium text-gray-700">
            测量时间
          </label>
          <input
            type="date"
