...
-- Generated at: 2025-11-08T05:16:01.877Z
-- Total Models: 68
-- Total Enums: 80
...
CREATE TABLE IF NOT EXISTS user (
  ...
  family_members FamilyMember[] NOT NULL,
...
ALTER TABLE user_preference ADD CONSTRAINT fk_user_preference_member
  FOREIGN KEY (member) REFERENCES family_member(id)
  ON DELETE CASCADE;
...
ALTER TABLE notification_preference ADD CONSTRAINT fk_notification_preference_member
  FOREIGN KEY (member) REFERENCES family_member(id)
  ON DELETE CASCADE;
...
CREATE INDEX idx_user_preference_member ON user_preference(member);
...
CREATE INDEX idx_notification_member ON notification(member);
CREATE INDEX idx_notification_member_id ON notification(member_id);
CREATE INDEX idx_notification_preference_member ON notification_preference(member);
